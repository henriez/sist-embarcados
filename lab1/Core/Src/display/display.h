...
// Colors for the screen (RGB565 format)
#define BLACK   0x0000
#define RED     0xF800
#define GREEN   0x07E0
#define BLUE    0x001F
...
// implemented with an ST7789, but caller doesnt need to know that
...
void display_drawCircle(uint16_t x, uint16_t y, uint16_t r, uint16_t padding, uint16_t foreground, uint16_t background);
